...
import { FitnessResultExpanded } from "../components/FitnessResultExpanded";
...
export function FitnessResult({business, onAdd, onDelete}:Prop) {
    ...
    return (
        ...
        <Modal
            ...
            >
        <FitnessResultExpanded business={business} onAdd={onAdd} onClose={closeModal}/>
