...
import { ExtraFormResultExpanded } from "../components/ExtraFormResultExpanded";
...
function ExtraFormResult({business, onAdd, onDelete}:Prop) {
...
let [ openExpanded, setOpenExpanded ] = useState(false);
    ...
    return (
        ...
        <Modal
            ...
            >
        <ExtraFormResultExpanded business={business} onAdd={onAdd} onClose={closeModal}/>
