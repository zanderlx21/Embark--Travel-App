...
import { AdventureResultExpanded } from "../components/AdventureResultExpanded";
...
export function AdventureResult({business, onAdd, onDelete}:Prop) {
    ...
    return (
        ...
        <Modal
            ...
            >
        <AdventureResultExpanded business={business} onAdd={onAdd} onClose={closeModal}/>
