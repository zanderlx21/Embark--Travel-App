...
import { FamilyResultExpanded } from "../components/FamilyResultExpanded";
...
export function FamilyResult({business, onAdd, onDelete}:Prop) {
    ...
    return (
        ...
        <Modal
            ...
            >
        <FamilyResultExpanded business={business} onAdd={onAdd} onClose={closeModal}/>
