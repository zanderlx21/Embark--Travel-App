...
import { RelaxationResultExpanded } from "../components/RelaxationResultExpanded";
...
export function RelaxationResult({business, onAdd, onDelete}:Prop) {
    ...
    return (
        ...
        <Modal
            ...
            >
        <RelaxationResultExpanded business={business} onAdd={onAdd} onClose={closeModal}/>
